...
int main (int argc, char *argv[]){
    ...
    for (int n=0;n<N;n++){//per ogni blocco
        ...
        if (n==0){
            ...
            error_1=sqrt((sqrd_cum_avg_1-cum_avg_1*cum_avg_1)/n); //calcola la deviazione standard cumulativa al blocco n
            error_2=sqrt((sqrd_cum_avg_2-cum_avg_2*cum_avg_2)/n); //calcola la deviazione standard cumulativa al blocco n
