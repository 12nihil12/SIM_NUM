...
int main(){
    ...
    for (int n=0; n < N; n++){ //itera sui blocchi
        ...
        for(int i=0;i<R;i++){ //iterando sui passi
            ...
            // Aggiunge il quadrato della media del nuovo blocco della alla media dei quadrati (per calcolo varianza)
    ...
    for(int i=0; i<R; i++){ //iterando sui passi
        ...
        //calcola la deviazione standard al blocco N 
...
void step_on_grid(Random *rnd,double *pos_grid ){
    ...
    int step=2*int(rnd->Rannyu(0,2))-1; //sceglie il valore dello step (-1,1) con probabilita' uniforme
